...
export function HeroBackdrop() {
  return (
    ...
    >
      <div className="mesh-layer mesh-a -left-[10%] top-[-20%] h-[70vh] w-[70vw] bg-[radial-gradient(circle,rgba(255,255,255,0.07)_0%,transparent_65%)]" />
      <div className="mesh-layer mesh-b -right-[15%] top-[10%] h-[60vh] w-[60vw] bg-[radial-gradient(circle,rgba(190,190,200,0.05)_0%,transparent_65%)]" />
      <div className="mesh-layer mesh-c left-[20%] bottom-[-25%] h-[55vh] w-[65vw] bg-[radial-gradient(circle,rgba(255,255,255,0.04)_0%,transparent_70%)]" />
    </div>
  );
}
