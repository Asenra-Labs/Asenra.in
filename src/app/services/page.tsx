...
const services = [
  ...
  {
    title: "Custom Local Apps",
    description: "Bespoke mobile and web apps for tiffins, salons, and local shops. Streamline operations and offer a premium customer experience.",
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
